...
<h2 class="h4 mb-3">Registro de Funcionários</h2>
      ...
      <tr>
        ...
        <td>
          <div class="d-flex justify-content-center gap-2">
            <a href="/funcionarios/{{ $f->id }}/edit" class="btn btn-warning btn-sm px-3">
              <i class="bi bi-pencil-square"></i> Editar
            </a>
            <a href="/funcionarios/{{ $f->id }}" class="btn btn-info btn-sm px-3 text-white">
